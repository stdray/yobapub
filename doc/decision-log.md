...
**Результат:** ждём выката и проверки. Сигнал успеха — только слова юзера (лог больше не различает плоскость); сигнал поломки — фатальные mediaError в легаси-сессиях.
